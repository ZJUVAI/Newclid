...
# -*- coding: utf-8 -*-
"""
Generate Synthetic Data from JGEX Problems

This script generates synthetic discovery data from JGEX format problems
(with auxiliary constructions). It bypasses the random clause generation
and directly uses the provided JGEX problems to extract proof traces.
"""
...
def main():
    ...
    # Initialize Ray
    logger.info(f"Initializing Ray with {args.max_workers} workers")

    # Use a custom temp directory to avoid conflicts
    import tempfile
    ray_temp_dir = tempfile.mkdtemp(prefix="ray_temp_")
    ...
    for i, problem in enumerate(problems):
        ...
        futures.append(process_jgex_problem.remote(task_args))
