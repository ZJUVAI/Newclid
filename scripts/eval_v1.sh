...
for checkpoint in "${checkpoints[@]}"; do
    ...
    for dataset in "${datasets[@]}"; do
        ...
        for config in "${configs[@]}"; do
            ...
            cmd="python scripts/evaluation_v1.py --problems_path benchmarks/$dataset --model_path ./models/$model_dir/$checkpoint --max_workers 40 --decoding_size $decoding_size --beam_size $beam_size --search_depth 4 --timeout $timeout"
