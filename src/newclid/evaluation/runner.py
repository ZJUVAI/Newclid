...
from newclid.agent.lm_multi_gpu import LMMultiGPUAgent
from newclid.agent.visual_multi_gpu import VisualMultiGPUAgent
from newclid.api import GeometricSolverBuilder
from newclid.evaluation.multi_gpu.model_pool import ModelPool, WorkerHandleWrapper
...
def create_workers(
    *,
    ...
    if agent_type == "lm":
        from newclid.evaluation.multi_gpu.lm_actor import ModelWorker
    ...
    if agent_type in {"vlm", "qwen35"}:
        from newclid.evaluation.multi_gpu.visual_actor import VisionModelWorker
