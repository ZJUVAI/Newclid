...
from newclid.evaluation.search_runtime import classify_build_exception
...
class AuxRewardEvaluator:
    ...
    def _evaluate_uncached(
        ...
        try:
            constructions = try_full_aux_dsl_to_constructions(aux_content)
    ...
    def _run_ddar(self, proof: ProofState) -> bool:
        ...
        ddar_config = load_solver_config()
