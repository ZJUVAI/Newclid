...
DETAIL_TIME_FIELDS = (
    ...
    "prepare_proof_fetch_work_time_s",
)
        ...
        writer.writerow(
            [
                (
                    ...
                    f"Prepare Proof Fetch Work Time: {summary['prepare_proof_fetch_work_time_s']:.2f}s, "
        ...
        for row in rows:
            writer.writerow(
                [
                    ...
                    f"{float(row.get('prepare_proof_fetch_work_time_s', 0.0)):.2f}",
