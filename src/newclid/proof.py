    ...
    def add_construction(self, construction: Clause):
        ...
        for constr_sentence in construction.sentences:
            ...
            for point in cdef.points:
                if mapping[point] in existing_point_names:
                    raise Exception(
                        f"The new point {mapping[point]} is already used. existing points: {existing_point_names}. construction: {construction}"
                    )
        ...
        for p in new_points:
            if p in existing_points:
                raise Exception(
                    f"The new points is already used. existing points: {existing_points}. construction: {construction}"
                )
