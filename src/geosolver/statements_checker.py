...
class StatementChecker:
    def __init__(
        ...
        self.NAME_TO_CHECK = {
            ...
            "rconst": self.check_rconst,
            "acompute": self.check_acompute,
            "rcompute": self.check_rcompute,
            "eqangle": self.check_const_or_eqangle,
            "eqangle6": self.check_const_or_eqangle,
            "eqratio": self.check_const_or_eqratio,
            "eqratio6": self.check_const_or_eqratio,
            "simtri": self.check_simtri,
            "simtri2": self.check_simtri,
            "simtri*": self.check_simtri,
            "contri": self.check_contri,
            "contri2": self.check_contri,
            "contri*": self.check_contri,
