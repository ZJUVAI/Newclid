...
class TestAR:
    ...
    def test_lconst_from_ratio_lconst(self):
        ...
        dependencies = [
            Dependency(Statement(preds.EqRatio, (a, b, b, c, d, e, e, f)), why=[]),
            Dependency(Statement(preds.ConstantLength, (a, b, l2)), why=[]),
            Dependency(Statement(preds.ConstantLength, (b, c, l5)), why=[]),
            Dependency(Statement(preds.ConstantLength, (d, e, l2)), why=[]),
        ]
        ...
        check.is_true(
            any(
                hash(Statement(preds.ConstantLength, (f, e, l5))) == hash(dep.statement)
