"""Tests for individual deduction rules.

Each test verifies that a single rule can solve a geometric problem in one step.
"""

import pytest
from newclid.api import GeometricSolverBuilder

# (rule_name, rule_text, problem_text, seed)
RULE_TESTS = [
    (
        "r00",
    ...
    pytest.param(
        ...
        123,
        marks=pytest.mark.xfail(reason="r13 cannot solve in one step"),
    ),
    (
        "r14",
    ...
    pytest.param(
        ...
        123,
        marks=pytest.mark.xfail(reason="r15 cannot solve in one step"),
    ),
    (
        "r16",
    ...
    pytest.param(
        ...
        123,
        marks=pytest.mark.xfail(reason="r21 cannot solve in one step"),
    ),
    (
        "r22",
    ...
    pytest.param(
        ...
        123,
        marks=pytest.mark.xfail(reason="r27 cannot solve in one step"),
    ),
    (
        "r28",
    ...
    pytest.param(
        ...
        123,
        marks=pytest.mark.xfail(reason="r29 cannot solve in one step"),
    ),
    (
        "r30",
...
@pytest.mark.parametrize("rule_name,rule_txt,problem_txt,seed", RULE_TESTS)
def test_rule_solves_in_one_step(
